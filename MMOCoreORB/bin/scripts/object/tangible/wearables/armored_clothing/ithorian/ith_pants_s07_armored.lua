...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_ithotian_ith_pants_s07_armored, "object/tangible/wearables/armored_clothing/ithorian/ith_pants_s07_armored.iff")
