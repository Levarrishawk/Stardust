...
ObjectTemplates:addTemplate(object_tangible_wearables_armored_clothing_ithotian_ith_hat_s03_armored, "object/tangible/wearables/armored_clothing/ithorian/ith_hat_s03_armored.iff")
