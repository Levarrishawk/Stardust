...
ObjectTemplates:addTemplate(object_tangible_loot_loot_schematic_carbine_charric_schematic, "object/tangible/loot/loot_schematic/weapon_schematic/carbine_charric_schematic.iff")
