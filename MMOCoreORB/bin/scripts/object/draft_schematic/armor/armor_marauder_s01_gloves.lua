object_draft_schematic_armor_armor_marauder_s01_gloves = object_draft_schematic_armor_shared_armor_marauder_s01_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Armor Gloves Starter",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s01_gloves, "object/draft_schematic/armor/armor_appearance_marauder_s01_gloves.iff")
