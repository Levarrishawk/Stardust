object_draft_schematic_armor_armor_marauder_s03_gloves = object_draft_schematic_armor_shared_armor_marauder_s03_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Armor Gloves Expert",
