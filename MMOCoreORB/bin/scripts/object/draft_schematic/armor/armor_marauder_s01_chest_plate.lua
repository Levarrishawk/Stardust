object_draft_schematic_armor_armor_marauder_s01_chest_plate = object_draft_schematic_armor_shared_armor_marauder_s01_chest_plate:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s01_chest.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s01_chest_plate, "object/draft_schematic/armor/armor_appearance_marauder_s01_chest.iff")
