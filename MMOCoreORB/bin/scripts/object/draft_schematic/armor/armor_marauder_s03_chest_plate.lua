object_draft_schematic_armor_armor_marauder_s03_chest_plate = object_draft_schematic_armor_shared_armor_marauder_s03_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Armor Chest Plate Expert",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s03_chest_plate, "object/draft_schematic/armor/armor_appearance_marauder_s03_chest.iff")
