object_draft_schematic_armor_armor_marauder_s01_belt = object_draft_schematic_armor_shared_armor_marauder_s01_belt:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s01_belt.iff",
