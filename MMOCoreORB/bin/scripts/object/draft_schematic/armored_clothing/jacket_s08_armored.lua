...
object_draft_schematic_armored_clothing_jacket_s08_armored = object_draft_schematic_armored_clothing_shared_jacket_s08_armored:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "[Armored] Rugged Jacket",
   ...
   targetTemplate = "object/tangible/wearables/armored_clothing/jacket/jacket_s08_armored.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_armored_clothing_jacket_s08_armored, "object/draft_schematic/armored_clothing/jacket_s08_armored.iff")
