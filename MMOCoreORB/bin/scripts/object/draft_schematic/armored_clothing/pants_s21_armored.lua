...
object_draft_schematic_armored_clothing_pants_s21_armored = object_draft_schematic_armored_clothing_shared_pants_s21_armored:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "[Armored] Paramilitary Camos",
   ...
   targetTemplate = "object/tangible/wearables/armored_clothing/pants/pants_s21_armored.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_armored_clothing_pants_s21_armored, "object/draft_schematic/armored_clothing/pants_s21_armored.iff")
