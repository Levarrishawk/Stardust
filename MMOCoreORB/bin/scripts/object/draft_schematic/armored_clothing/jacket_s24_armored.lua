...
object_draft_schematic_armored_clothing_jacket_s24_armored = object_draft_schematic_armored_clothing_shared_jacket_s24_armored:new {
   ...
   resourceTypes = {"ore_intrusive", "object/tangible/wearables/jacket/shared_jacket_s24.iff", "fiberplast", "aluminum", "copper_beyrllius", "hide_wooly", "object/tangible/wearables/armor/zam/shared_armor_zam_wesell_chest_plate.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff", "object/tangible/component/clothing/shared_reinforced_fiber_panels.iff"},
