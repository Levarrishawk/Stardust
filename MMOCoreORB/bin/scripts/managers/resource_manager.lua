...
activeZones = "corellia,tatooine,lok,naboo,rori,endor,talus,yavin4,dathomir,dantooine,kaas,chandrila,moraband,hutta,florrum"
...
minimumpoolincludes = { {"steel", 1}, {"copper", 1}, {"aluminum", 1}, {"ore_extrusive", 1}, {"ore_intrusive", 1}, {"ore_carbonate", 1}, {"gemstone_crystalline", 1}, {"gemstone_armophous", 1}, {"radioactive_known", 1}, {"fuel_petrochem_solid", 1}, {"fuel_petrochem_liquid", 1}, {"petrochem_inert_polymer", 2}, {"petrochem_inert_lubricating_oil", 2}, {"gas_reactive_irolunn", 1}, {"ore_carbonate_alantium", 1}, {"radioactive_type2", 1}, {"crystalline_sormahil_firegem", 1}, {"ore_carbonate_frasium", 1}, {"ore_siliclastic_malab", 1}, {"ore_intrusive_chanlon", 1} }
