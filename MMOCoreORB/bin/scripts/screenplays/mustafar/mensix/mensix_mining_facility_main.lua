...
function mensix_mining_facility_main:start()
	if (isZoneEnabled("mustafar")) then
		...
		self:spawnConvoActiveArea1()
	end
end

function mensix_mining_facility_main:spawnConvoActiveArea1()
  local pConvoArea1 = spawnSceneObject("mustafar", "object/active_area.iff", -2476, 230, 1647, 0, 12112248)
    
  if (pConvoArea1 ~= nil) then
    local activeArea6 = LuaActiveArea(pConvoArea1)
          activeArea6:setCellObjectID(12112248)
          activeArea6:setRadius(20)
          createObserver(ENTEREDAREA, "mensix_mining_facility_main", "touristConvoStart", pConvoArea1)
...
function mensix_mining_facility_main:touristConvoStart(pTraveler_m, pTraveler_f)
  ...
  spatialChat(wife, "I cannot believe you took me to this flaming hunk of rock! What were you thinking? This world is a nightmare.") -- I cannot believe you took me to this flaming hunk of rock! What were you thinking? This world is a nightmare.
...
function mensix_mining_facility_main:touristConvo5(pTraveler_m, pTraveler_f)
  ...
  spatialChat(husband, "Yes, dear. Whatever you say.") -- Yes, dear. Whatever you say.
