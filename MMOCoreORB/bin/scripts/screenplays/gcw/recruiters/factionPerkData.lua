...
rebelRewardData = {
	...
	installations = {
		barc_rebel = {type=factionRewardType.installation, display="@deed:barc_s01_rebel", item="object/tangible/deed/vehicle_deed/barc_speeder_rebel_deed.iff", generatedObjectTemplate="object/mobile/vehicle/barc_speeder_rebel.iff", cost=30000},
...
imperialRewardData = {
	...
	installations = {
	  barc_imperial = {type=factionRewardType.installation, display="@deed:barc_s01_imperial", item="object/tangible/deed/vehicle_deed/barc_speeder_imperial_deed.iff", generatedObjectTemplate="object/mobile/vehicle/barc_speeder_imperial.iff", cost=30000 },
