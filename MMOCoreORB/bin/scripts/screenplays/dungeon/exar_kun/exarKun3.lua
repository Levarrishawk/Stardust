...
function exarKun3:spawnBossRoomOneActiveArea()  -- Active areas use world coords.   Set to actual world coord in each instance manually.
  local pActiveArea1 = spawnSceneObject("yavin4", "object/active_area.iff", 3682, 792, -2168, 0, 0, 0, 0, 0)
  if (pActiveArea1 ~= nil) then
    local activeArea = LuaActiveArea(pActiveArea1)
          activeArea:setCellObjectID(480000310)
...
function exarKun3:spawnBossRoomFour()
  local boss4 = spawnMobile("yavin4", "exar_kun_fist_of_hate", 0, 15.6, 0.0, 92.8, 178, 480000315)
    ...
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 71.4, -90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 75.4, -90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 79.4, -90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 83.4, -90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 87.4, -90, 480000315)
    
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 71.4, 90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 75.4, 90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 79.4, 90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 83.4, 90, 480000315)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 87.4, 90, 480000315)
