...
function exarKun4:spawnBossRoomFour()
  local boss4 = spawnMobile("yavin4", "exar_kun_fist_of_hate", 0, 15.6, 0.0, 92.8, 178, 480000323)
    ...
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 71.4, -90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 75.4, -90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 79.4, -90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 83.4, -90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, 33.2, -0.1, 87.4, -90, 480000323)
    
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 71.4, 90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 75.4, 90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 79.4, 90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 83.4, 90, 480000323)
    spawnMobile("yavin4", "insane_vitiate_cultist", 0, -3.0, -0.1, 87.4, 90, 480000323)
