...
obi_wan_elysium_start = ConvoScreen:new {
  ...
  leftDialog = "",
  customDialogText = "Hello there my young friend.  You appear to be lost.  Have you lost your way?",
...
opt2 = ConvoScreen:new {
  id = "opt2",
  leftDialog = "",
   customDialogText = "This place is unusually strong with the force.  It is a conduit within the very fabric of the cosmic force.  It connects to a variety of places and times.  I know little about it except that it is old.  Perhaps older than even the Jedi Order itself.  The ancient Jedi knew of this place and accessed it through some of the oldest Jedi Temples in the Galaxy.   Which I assume is where you come in.",
  stopConversation = "false",
  options = {
     {"Yes, an ancient enclave on Yavin 4.","opt2a"},   
  }
}
...
opt2d = ConvoScreen:new {
  id = "opt2d",
  leftDialog = "",
   customDialogText = "You can either go back to the place you came from, or you can take one of these paths, but be warned.  Each path has it's own risks.  You must be cautious.",
  stopConversation = "false",
  options = {
